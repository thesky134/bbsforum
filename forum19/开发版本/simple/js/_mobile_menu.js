...
(function (){
	...
	ttSearchWrapper.on('click', ttSearchToggle , function(e) {
		$(this).addClass('tt-open-popup');
        return false;
    });
    ttSearchWrapper.on('click', '.tt-search__close' , function(e) {
		ttSearchWrapper.removeClass('tt-open-popup');
        return false;
    });
})();